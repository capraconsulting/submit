...
viewSubmissionDetails submission model =
    div []
        ...
        , div [ class <| "edit-intro " ++ hideIfNotEditable submission.editable ]
            ...
            , p [ class "ingress" ] [ text "CapraCon takes place in Oslo, Norway, on September 13th-14th 2017. Do YOU want to be one of the great speakers at our conference? Fantastic! That's what this thing is for! Let's get you started!" ]
            , div [ class "help-part" ]
            ...
            , div [ class "help-part" ]
                ...
                , p [] [ text "By the end of June, all speakers will be get info about whether their talk is selected or not. Fingers crossed! If you are selected, you get to talk at CapraCon 2017!" ]
                ]
            ]
        , div [ class "edit-submission" ]
            ...
            , div [ class <| "input-section " ++ hideIfNotEditable submission.editable ]
                ...
                , p [ class "input-description input-description-strong" ] [ text "Make sure you mark it as ready by April 24th at the latest to have your talk considered for CapraCon 2017! Mark your calendar! ;)" ]
